...
- **Apps**:
  - `apps/dotrun`: TanStack Start React app (k9.run)
  - `apps/dotdev`: TanStack Start React app (k9.dev)
...
| Command                | Purpose                               |
| ---------------------- | ------------------------------------- |
| `pnpm dev:dotrun`      | Start dotrun app (port 3000) + Convex |
...
- **Routing**: File-based in `apps/dotrun/src/routes/`
- **Generated Files**:
